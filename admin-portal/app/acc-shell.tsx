...
export function AccShell({ role, children }: { role: string; children: ReactNode }) {
  return <main className="admin-shell">
    <header className="topbar"><div><p className="eyebrow">ADMIN CONTROL CENTER · BETA 1.3.0</p><h1>YHCT Social · v2.0</h1></div><div className="top-actions"><span className="role-pill">{role}</span><button className="secondary" onClick={() => void signOut(auth)}>Đăng xuất</button></div></header>
